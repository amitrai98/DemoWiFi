...
public abstract class WifiScanResultAdapter <ITEM_T, VIEW_MODEL_T extends ItemViewModel<ITEM_T>>
        extends RecyclerView.Adapter<WifiScanResultAdapter.ItemViewHolder<ITEM_T, VIEW_MODEL_T>> {
